    ...
    <form action="{{route('mahasiswa.store')}}" method="post">
        ...
        <div class="mb-2">
            ...
            <input type="text" id="nim" name="nim"
                ...
                @error('nim') border-red-500 @enderror" placeholder="Masukkan NIM mahasiswa" value="{{old('nim')}}">
        </div>
        @error('nim')
        ...
        <div class="mb-2">
            ...
            <input type="text" id="nama" name="nama"
                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500
                @error('nama') border-red-500 @enderror" placeholder="Masukkan nama mahasiswa" value="{{old('nama')}}">
        </div>
        @error('nama')
        <div class="text-red-500 text-sm mb-2">
            {{$message}}
        ...
        <div class="mb-2">
            ...
            <input type="text" id="alamat" name="alamat"
                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500
                @error('alamat') border-red-500 @enderror" placeholder="Masukkan alamat" value="{{old('alamat')}}">
        </div>
        @error('alamat')
        <div class="text-red-500 text-sm mb-2">
            {{$message}}
        ...
        <div class="mb-2">
            ...
            <select id="dropdownSelect" name="kode_prodi"
                ...
                <option value="{{old('kode_prodi')}}">Pilih prodi</option>
