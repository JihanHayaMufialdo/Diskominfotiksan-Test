    ...
    <form action="{{route('prodi.store')}}" method="post">
        ...
        <div class="mb-2">
            ...
            <input type="text" id="kode_prodi" name="kode_prodi"
                ...
                @error('kode') border-red-500 @enderror" placeholder="Masukkan kode program studi" value="{{old('kode')}}">
        </div>
        @error('nama')
        ...
        <div class="mb-2">
            ...
            <input type="text" id="nama_prodi" name="nama_prodi"
                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500
                @error('prodi') border-red-500 @enderror" placeholder="Masukkan nama program studi" value="{{old('prodi')}}">
        </div>
        @error('prodi')
        <div class="text-red-500 text-sm mb-2">
            {{$message}}
        ...
        <div class="mb-2">
            ...
            <input type="text" id="jurusan" name="jurusan"
                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500
                @error('jurusan') border-red-500 @enderror" placeholder="Masukkan nama jurusan" value="{{old('jurusan')}}">
        </div>
        @error('jurusan')
        <div class="text-red-500 text-sm mb-2">
            {{$message}}
